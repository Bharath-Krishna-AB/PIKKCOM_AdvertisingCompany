    ...
    return (
        <div ref={containerRef} className="bg-primary min-h-screen selection:bg-accent/30">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
                    ...
                    <div className="lg:col-span-7 content-block">
                        ...
                        <p className="text-lg md:text-2xl font-sans font-light text-secondary/90 leading-relaxed whitespace-pre-line">
                            We use AI and data intelligence to understand how customers choose, how demand evolves, and where new opportunities are forming. By analyzing behavioral signals, market dynamics, and predictive indicators, we surface customer preferences, emerging trends, and structural gaps across categories. This creates a clear, continuously updated view of the market—what’s changing, what’s growing, and what’s coming next.
                        </p>
                    </div>
            ...
            <div className="px-6 md:px-12 max-w-[1920px] mx-auto mb-20 content-block">
                <Link href="/solutions/selection" className="group inline-flex flex-col gap-2">
