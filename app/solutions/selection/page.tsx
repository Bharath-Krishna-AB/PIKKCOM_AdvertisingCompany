    ...
    return (
        <div ref={containerRef} className="bg-primary min-h-screen selection:bg-accent/30">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
                    ...
                    <div className="lg:col-span-7 content-block">
                        ...
                        <p className="text-lg md:text-2xl font-sans font-light text-secondary/90 leading-relaxed whitespace-pre-line">
                            We turn intelligence into action by helping brands decide where to focus. Using AI-driven scoring and portfolio modeling, we evaluate large product catalogs to rank, prioritize, and shortlist the products with the strongest commercial potential. This enables teams to concentrate investment on high-impact SKUs, simplify complex assortments, and improve profitability through sharper focus and faster decision-making.
                        </p>
                    </div>
                    ...
                    <div className="lg:col-span-5 content-block">
                        ...
                        <ul className="space-y-4">
                            {[
                                "Best product shortlisting",
                                "Product ranking and prioritization",
                                "Focus products for better profit"
                            ].map((cap, i) => (
            ...
            <div className="px-6 md:px-12 max-w-[1920px] mx-auto mb-20 content-block">
                <Link href="/solutions/media" className="group inline-flex flex-col gap-2">
